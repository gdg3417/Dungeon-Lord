...
The owner-design gate for branching and route choice is approved in the [Phase 5 branching and route-choice design lock](phase-5-branching-and-route-choice-design.md). Phase 5 implementation, configuration tuning, automated validation, manual gameplay validation, and merge qualification remain outstanding.
...
| Narrow branch selection formula and deterministic tie-break | Approved owner design | [Phase 5 branching and route-choice design lock](phase-5-branching-and-route-choice-design.md); exact numeric tuning, implementation, and deterministic test evidence remain Phase 5 work |
