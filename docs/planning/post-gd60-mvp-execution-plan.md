...
**Current status (2026-09-16):** Phase 3 is closed through merged PR #200. Phase 4 packets #201 through #205 are merged and qualified, with PR #205 providing canonical passive online mana. Current main baseline is PR #205 at `f15504729716cc4ac22b0eb7070d91a92d3cd20d`. The current packet adds canonical offline passive mana at a tunable 15% base efficiency, retaining fractional precision and the locked no-duration-cap rule. Schema remains 9. Run-event mana remains later work. Prior qualification evidence applies to its recorded commits, not this change. Earlier status blockers below are historical and superseded.
