...
| Field | Decision |
|---|---|
| Status | **GD65B closed by merged PR #186; GD66 active** |
...
### Phase 1 — Spatial domain foundation (GD65B5 complete in merged PR #186; GD66 active; runtime remains inactive)
