...
| Field | Decision |
|---|---|
| Status | **PRs #201 and #202 merged/qualified; PR #203 acquisition/StartingMana qualified, not yet merged** |
| Historical approval baseline | Main through merged PR #179 / GD65B1 at `917b763dc0e5315fdd5d835da4b5f5de43f9ba59` |
| Current implementation baseline | Main at merged PR #202 `c1c7b2ceb8dcc628d6e0030b9996ffc28498c3fb` |
...
Direct content unassignment/reconfiguration remains a follow-up usability gap: no player action removes an individual monster, trap or loot item without deleting its room/save. Reusable monsters/traps should preserve owned AssignmentId by moving to returned custody; loot disposition requires explicit gameplay/policy approval. This is separate from structural room deletion and is not implemented in PR #203.
...
| Content acquisition prices and starting mana | Current packet after merged/qualified PR #202 | Approved tunable config: eight prices and StartingMana 40; PR #203 qualified, not yet merged; structural prices unchanged |
