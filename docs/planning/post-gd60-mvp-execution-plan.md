...
**Current status (2026-09-17):** Phase 3 is closed through merged PR #200. Phase 4 packets #201 through #205 are merged and qualified, with PR #205 providing canonical passive online mana. Latest repository main is PR #206 at `f32b3ee94cf72cade159c2b5bfeba0a7ed4ee3a6`; the latest gameplay-capability baseline remains PR #205 at `f15504729716cc4ac22b0eb7070d91a92d3cd20d`, while PR #206 adds passive-mana test portability only. The current unmerged packet adds canonical offline passive mana at a tunable 15% base efficiency, retaining fractional precision and the locked no-duration-cap rule. Schema remains 9. Run-event mana remains later work. Prior qualification evidence applies to its recorded commits, not this change. Earlier status blockers below are historical and superseded.
...
| Field | Decision |
|---|---|
| Status | **PRs #201 through #206 merged; gameplay capability is qualified through #205, and canonical offline passive mana is the current unmerged packet** |
| Historical approval baseline | Main through merged PR #179 / GD65B1 at `917b763dc0e5315fdd5d835da4b5f5de43f9ba59` |
| Current implementation baseline | Repository main at merged PR #206 `f32b3ee94cf72cade159c2b5bfeba0a7ed4ee3a6`; gameplay capability baseline PR #205 `f15504729716cc4ac22b0eb7070d91a92d3cd20d` |
...
- **Economy/offline:** structural spending/refunds, owned-content redeployment, paid acquisition/StartingMana, direct unassignment, and canonical passive online mana are merged/qualified through PRs #201–#205. The current packet adds one deterministic offline grant for cold start and pause/resume using the #205 rate, a validated 15% base efficiency, fractional wallet precision, no duration cap, capacity clamping, atomic timestamp consumption, localized summary, and structured security evidence. Floor expansion remains deferred.
...
### Phase 3 — Structural editing rules (closed at PR #200)
...
**Merged and qualified PR #202:** explicit redeployment reuses owned returned custody while preserving identity at zero mana cost. **Merged and qualified PR #203 acquisition packet:** configuration-owned prices are Skeleton 25, Goblin 20, Spike 20, Snare 15, Chilling Sigil 20, Basic Loot 15, Hidden Cache 10 and Glittering Hoard 25 mana; fresh native StartingMana is 40. **Merged and qualified PR #204:** direct unassignment returns the selected existing content identity to custody without changing mana or structure. Ordinary NEW acquisition remains the only paid content path, schema remains 9, and exact transaction semantics are recorded in the [Phase 4A contract](phase-4a-structural-economy.md).

**Canonical passive mana packets:** PR #205 established the online authority: `passive_online_mana.json` owns the temporary MVP Core Level 1 input, coefficients, Peace/Notice/Concern efficiencies, and disabled soft cap. The current packet extends that same validated authority with `BaseOfflineEfficiency = 0.15` and consumes the canonical applicable online rate for exact elapsed seconds. The grant has no duration cap, keeps fractional mana, freezes Heat, clamps only at structural capacity, and atomically commits wallet plus timestamp before publication. Research may later modify effective efficiency through the explicit input seam; no research content or save field is added. Structured grant and clock evidence must be consumed by security monitoring before MVP completion, but this client packet does not claim deliberate clock-cheat detection. Run-event mana, durable Core Level progression, research mana effects, and active soft-cap tuning remain deferred.
...
Phase 3 is closed through merged PR #200, Phase 4 gameplay packets #201 through #205 are merged and qualified, and test-portability PR #206 is merged. Latest repository main is PR #206 at `f32b3ee94cf72cade159c2b5bfeba0a7ed4ee3a6`; the latest gameplay-capability baseline remains PR #205 at `f15504729716cc4ac22b0eb7070d91a92d3cd20d`. The current unmerged dependency packet adds canonical offline passive mana using the #205 online resolver, configuration-owned 15% base efficiency, exact elapsed seconds without a duration cap, fractional wallet precision, structural-capacity clamping, monotonic/atomic timestamp consumption, localized player-facing Bootstrap presentation, and structured security evidence. Schema remains 9. Run-event mana, durable Core Level progression, research mana effects, active soft-cap tuning, and authoritative clock-cheat enforcement remain explicitly deferred. Prior qualification evidence applies to its recorded commits, not this correction.
