...
**Current Phase 3 status (2026-08-22):** PR #196 and Phase 3A are merged and complete at `b6bd4a2dfa85a1b8899c617dd0d1982a91a879c1`. Phase 3B1 implements stable-identity movement and replacement renovation: it derives the no-branch required path from graph identities, rigidly translates the affected downstream group and internal corridors, deterministically reconnects changed boundaries with the approved Direct Doorway or Straight Stone Corridor representation, preserves room/node/edge/fixed-structure/assignment identities and contents, and commits detached candidates through the existing schema-7 write authority. Structural deletion is separated into Phase 3B2 and remains blocked on explicit structural-ID lifecycle, content-return authority, Completion Terminal reconnection, and removed-edge identity policy. No Phase 4 mana-backed construction work should begin until Phase 3B2 closes the Phase 3 exit criteria.**
...
**Packet status:** Phase 3A construction is complete. Phase 3B1 owns movement and replacement renovation only. Phase 3B2 owns deletion and cannot proceed until stable-ID retirement/reuse, content return, Completion Terminal reconnection, and removed-edge identity are explicitly approved.
