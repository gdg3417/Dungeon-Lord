...
| Docs/32 - Event_Framework_and_Rule_Overrides.md | Limited override support | MVP Vertical Slice Polish | S4-T04 | Sprint 4 | Needs Clarification | Explicitly constrained to MVP-safe subset. |
