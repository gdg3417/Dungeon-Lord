...
| Undead and Goblinoid launch families / one boss set each | Locked MVP source | Partial or requires confirmation | Starter content is not full-family evidence | Exact breadth requires confirmation | Required Phase 8 content; validate Phase 9 |
