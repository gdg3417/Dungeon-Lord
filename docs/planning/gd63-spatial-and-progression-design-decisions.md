...
**Current repository status (2026-09-26):** Phase 3 is closed through merged PR #200, Phase 4 is complete through PR #207, the Phase 5 design lock is merged in PR #208, and Phase 5A is complete in PR #209. Canonical spatial state is active writable route/content authority; `DeadEnd = 6`, optional-branch persistence, corridor content, and shared branch knowledge are implemented in current writable schema 10. Phase 5B is the next gameplay packet; route choice, optional traversal, branch encounter resolution, branch-specific outcomes, run-driven knowledge learning, and production tuning remain unimplemented. The unresolved authority is recorded in the [Phase 5B production tuning and run-condition contract](phase-5b-production-tuning-and-run-condition-contract.md). PR #210 makes the AI model-selection policy canonical. The historical GD63 decisions below remain historical context.
