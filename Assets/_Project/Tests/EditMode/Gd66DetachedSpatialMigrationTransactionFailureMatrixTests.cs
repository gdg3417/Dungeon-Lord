    ...
    public sealed class Gd66DetachedSpatialMigrationTransactionFailureMatrixTests
    {
        ...
        private static IEnumerable<MatrixCase> Cases
        {
            get
            {
                ...
                yield return C("replaced-active-read-exception", EntryPoint.Recover, MatrixCheckpoint.Replaced, MatrixOperation.Read, PathRole.Active, DetachedSpatialMigrationTransaction.RecoveryFailedReason, SpatialMigrationJournalStage.Replaced, MatrixAuthority.Candidate, ActiveExpectation.Candidate, E(journal:true, backup:true), 0, EntryPoint.Recover, true, DetachedSpatialMigrationTransaction.SuccessReason, SpatialMigrationJournalStage.Finalized, MatrixAuthority.Candidate, ActiveExpectation.Candidate, 0);
                yield return C("durable-final-receipt-write", EntryPoint.Recover, MatrixCheckpoint.DurableVerified, MatrixOperation.DurableWrite, PathRole.Receipt, DetachedSpatialMigrationTransaction.SuccessReason, SpatialMigrationJournalStage.Finalized, MatrixAuthority.Candidate, ActiveExpectation.Candidate, E(journal:true, backup:true), 0, EntryPoint.Recover, true, DetachedSpatialMigrationTransaction.SuccessReason, SpatialMigrationJournalStage.Finalized, MatrixAuthority.Candidate, ActiveExpectation.Candidate, 0, firstSuccess:true);
                yield return C("durable-final-journal-advance", EntryPoint.Recover, MatrixCheckpoint.DurableVerified, MatrixOperation.AtomicReplace, PathRole.Journal, DetachedSpatialMigrationTransaction.FinalizationFailedReason, SpatialMigrationJournalStage.DurableVerified, MatrixAuthority.Candidate, ActiveExpectation.Candidate, E(journal:true, backup:true, receipt:true), 0, EntryPoint.Recover, true, DetachedSpatialMigrationTransaction.SuccessReason, SpatialMigrationJournalStage.Finalized, MatrixAuthority.Candidate, ActiveExpectation.Candidate, 0);
