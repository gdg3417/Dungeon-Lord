    ...
    public sealed class Gd66DetachedSpatialMigrationTransactionFailureMatrixTests
    {
        ...
        private static IEnumerable<MatrixCase> Cases
        {
            get
            {
                ...
                yield return C("finalization-receipt-write", EntryPoint.Recover, MatrixCheckpoint.FinalizationAttempt, MatrixOperation.DurableWrite, PathRole.Receipt, DetachedSpatialMigrationTransaction.SuccessReason, SpatialMigrationJournalStage.Finalized, MatrixAuthority.Candidate, ActiveExpectation.Candidate, E(journal:true, backup:true), 0, EntryPoint.Recover, true, DetachedSpatialMigrationTransaction.AlreadyCommittedReason, null, MatrixAuthority.Candidate, ActiveExpectation.Candidate, 0, firstSuccess:true);
