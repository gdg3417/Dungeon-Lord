    ...
    public class MvpDungeonPlacementScaffoldTests
    {
        ...
        private static string Localized(string key, string fallback)
        {
            var map = new Dictionary<string, string>
            {
                ...
                [MvpLoopSummaryPanelPresenter.WhyNoRunKey] = "No run yet. Build or review the dungeon, then run it to learn what happens.",
                ...
                [MvpLoopSummaryPanelPresenter.WhyPathCapacityKey] = "path capacity shaped the run",
                [MvpLoopSummaryPanelPresenter.WhyDangerKey] = "danger pressure drove the result",
                [MvpLoopSummaryPanelPresenter.WhyManaPressureKey] = "mana pressure constrained the run",
